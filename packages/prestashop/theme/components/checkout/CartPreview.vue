    ...
    <div class="highlighted promo-code">
      ...
      <transition name="fade">
        <div v-if="showPromoCode">
          ...
          />
          <SfButton class="sf-button--full-width" @click="applyCoupon({coupon: promoCode})">Apply code</SfButton>
        </div>
      </transition>
    </div>
    <div class="highlighted">
...
import { useCart, useCheckout, checkoutGetters, cartGetters } from '@jkawulok/prestashop-composables';
